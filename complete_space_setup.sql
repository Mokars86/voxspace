...
-- 2. Reset and Apply RLS Policies
-- Enable RLS
...
-- FIXED Insert Policy: Checks sender_id and membership correctly
...
-- 3. Setup Member Count Triggers
-- Drop old triggers to prevent duplication
